...
namespace CourierAmex.Controllers
{
    ...
    public class DocumentTypeController : ControllerBase
    {
        ...
        public DocumentTypeController(ILogger<DocumentTypeController> logger, IDocumentTypeService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        {
            GenericResponse<DocumentTypeModel>? response;
            try
            {
            ...
            {
                _logger.LogError($"There was an error on 'DocumentType_GetById' invocation. {ex.Message}");
        ...
        {
            PagedResponse<DocumentTypeModel> response;
            try
            {
            ...
            {
                _logger.LogError($"There was an error on 'DocumentType_GetPaged' invocation. {ex.Message}");
                return StatusCode(400, ex.Message);
            }
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] DocumentTypeModel entity)
        {
            ...
            {
                _logger.LogError($"There was an error on 'DocumentType_Post' invocation. {ex.Message}");
                return StatusCode(400, ex.Message);
            }
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] DocumentTypeModel entity)
        {
            var context = HttpContext.GetWorkContext();
            GenericResponse<DocumentTypeModel> response;
            try
            ...
            {
                _logger.LogError($"There was an error on 'DocumentType_Put' invocation. {ex.Message}");
                return StatusCode(400, ex.Message);
            }
        ...
        public async Task<IActionResult> Delete([FromQuery] int id)
        {
            ...
            {
                _logger.LogError($"There was an error on 'DocumentType_Delete' invocation. {ex.Message}");
                return StatusCode(400, ex.Message);
            }
