...
namespace CourierAmex.Controllers
{
    ...
    public class PaymentTypeController : ControllerBase
    {
        ...
        public PaymentTypeController(ILogger<PaymentTypeController> logger, IPaymentTypeService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        {
            GenericResponse<PaymentTypeModel>? response;
            try
            {
            ...
            {
                _logger.LogError($"There was an error on 'PaymentType_GetById' invocation. {ex.Message}");
        ...
        {
            PagedResponse<PaymentTypeModel> response;
            try
            {
            ...
            {
                _logger.LogError($"There was an error on 'PaymentType_GetPaged' invocation. {ex.Message}");
                return StatusCode(400, ex.Message);
            }
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] PaymentTypeModel entity)
        {
            ...
            {
                _logger.LogError($"There was an error on 'PaymentType_Post' invocation. {ex.Message}");
                return StatusCode(400, ex.Message);
            }
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] PaymentTypeModel entity)
        {
            var context = HttpContext.GetWorkContext();
            GenericResponse<PaymentTypeModel> response;
            try
            ...
            {
                _logger.LogError($"There was an error on 'PaymentType_Put' invocation. {ex.Message}");
                return StatusCode(400, ex.Message);
            }
        ...
        public async Task<IActionResult> Delete([FromQuery] int id)
        {
            ...
            {
                _logger.LogError($"There was an error on 'PaymentType_Delete' invocation. {ex.Message}");
                return StatusCode(400, ex.Message);
            }
