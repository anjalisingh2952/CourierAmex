...
namespace CourierAmex.Controllers
{
    ...
    public class ClientCategoryController : ControllerBase
    {
        ...
        public ClientCategoryController(ILogger<ClientCategoryController> logger, IClientCategoryService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        {
            GenericResponse<ClientCategoryModel>? response;
            try
            {
            ...
            {
                _logger.LogError("There was an error on 'ClientCategory_GetById' invocation.", ex.Message);
        ...
        {
            PagedResponse<ClientCategoryModel> response;
            try
            {
            ...
            {
                _logger.LogError("There was an error on 'ClientCategory_GetPaged' invocation.", ex.Message);
                return StatusCode(400, ex.Message);
            }
        ...
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] ClientCategoryModel entity)
        {
            ...
            {
                _logger.LogError("There was an error on 'ClientCategory_Post' invocation.", ex.Message);
                return StatusCode(400, ex.Message);
            }
        ...
        [HttpPut]
        public async Task<IActionResult> Put([FromBody] ClientCategoryModel entity)
        {
            var context = HttpContext.GetWorkContext();
            GenericResponse<ClientCategoryModel> response;
            try
            ...
            {
                _logger.LogError("There was an error on 'ClientCategory_Put' invocation.", ex.Message);
                return StatusCode(400, ex.Message);
            }
        ...
        [HttpDelete]
        public async Task<IActionResult> Delete([FromQuery] byte id)
        {
            ...
            {
                _logger.LogError("There was an error on 'ClientCategory_Delete' invocation.", ex.Message);
                return StatusCode(400, ex.Message);
            }
